...
3. 話せない言葉は、聞き取るのも難しいからです。（そして聞き取れたとしても、慣れないフレーズはシステム２で処理しなければならないため、非常に処理に時間とエネルギーを使います。実際のリスニングでは大量の情報が絶え間なく流れてくるため、システム２で処理を始めた時点でそこから後のインプットに割く計算能力が枯渇します。つまり長いリスニングができない。）
...
1. **安いポータブルオーディオプレーヤーを買ってください。** 充電切れ（ダウンタイム）を防ぐために2台持っておきたいところです。
    ...
    * 学習用のデバイスをもっていれば、それが視界に入った瞬間に「学習」をことだけを思い出します。これはスマートフォンには持てない機能です。あなたはスマートフォンを見たとき、SNSや友達、あるいはゲームや予定のことを思い出します。
