...
3. 話せない言葉は、聞き取るのも難しいからです。（そして聞き取れたとしても、慣れないフレーズはシステム２で処理しなければならないため、処理に時間とエネルギーを使います。実際のリスニングでは大量の情報が絶え間なく流れてくるため、システム２で処理を始めた時点でそこから後のインプットに割く計算能力が枯渇します。つまり長いリスニングができない。）
